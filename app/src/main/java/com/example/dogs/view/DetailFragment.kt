...
class DetailFragment : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.actionSendSms -> {
                ...
                sendSmsStarted = true
                //Only Activity can check permissions
            ...
            R.id.actionShare -> {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "Some dog info")
    ...
    fun onPermissionResult(premissionGranted: Boolean) {
        if (sendSmsStarted && premissionGranted) {
            context?.let {
                val smsInfo = SmsInfo(
                    "",
